...
ROOT=`pwd`
EXEC="orcs -t"
SINUCA="/home/ricardo/sinuca/./sinuca -config /home/ricardo/sinuca/config_examples/sandy_1core/sandy_1core.cfg -trace "
TRACE_FOLDER="traces/"
...
do  
    # { time ${ROOT}'/'./${EXEC} ${TRACE_FOLDER}${BENCHMARK_FOLDER}${i}'/'${i}; } 2>>${ORCS_D}'/'${i}.txt
    # sleep 5
    ${SINUCA} ${TRACE_FOLDER}${BENCHMARK_FOLDER}${i}'/'${i} "-result" ${SINUCA_D}'/'${i}.txt
    sleep 5
done
