...
def main():
    ...
    fields_required=['benchmark','Total_Cycle','fetch_instructions',None,'times_llc_rob_head','started_emc_execution','LLC_Cache_Miss','numero_load_deps','total_instruction_sent_emc'] 
    folder = sys.argv[1]
